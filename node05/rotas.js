...
let estoque = [
    {id: 1, nome: 'tomate', preco: 5},
    {id: 2, nome: 'cebola', preco: 10},
    {id: 3, nome: 'cenoura', preco: 7}
]

let usuarios = [
    {id: 1, nome: 'Andre', tipo: 'fornecedor'},
    {id: 2, nome: 'Bernardo', tipo: 'fornecedor'},
    {id: 3, nome: 'Carmel', tipo: 'cliente'}
]
